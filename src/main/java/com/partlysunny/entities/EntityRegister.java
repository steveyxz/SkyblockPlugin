...
public class EntityRegister {
    ...
    public static void registerEntityInfos() {
        EntityManager.addEntity(new EntityInfo("super_zombie", "Super Zombie Defender", ChatColor.GOLD, 5, false, new EntityStatSet(
                new EntityStat(EntityStatType.MAX_HEALTH, 300),
                new EntityStat(EntityStatType.DEFENSE, 300),
                new EntityStat(EntityStatType.SPEED, 100),
                new EntityStat(EntityStatType.DAMAGE, 300)
        )));
    }
